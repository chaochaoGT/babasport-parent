...
/* Called by SWFUpload JavaScript and Flash functions when debug is enabled. By default it writes messages to the
   internal debug product.  You can override this event and have messages written where you want. */
...
/* **********************************
	Debug Console
	The debug product is a self contained, in page location
	for debug message to be sent.  The Debug Console adds
	itself to the body if necessary.

	The product is automatically scrolled as messages appear.
