...
//搜索
function serachKeyword(solt,pageNum,pageSize,pages){
    if (pageNum < 1) {
        pageNum = 1
    }
    if (pageNum > pages) {
	...
	window.location = "search?pageNum="+pageNum+"&pageSize="+pageSize+"&keyword=" + $("#keyword").val()+"&solt="+solt;
}
</script>
<!--shortcut start-->
		...
		<div id="search-2013">
			<div class="i-search ld">
				...
				<div class="form">
					...
					<input type="button" value="搜索" class="button" onclick="serachKeyword('','${superPojo.pageNum}','${superPojo.pageSize}','${superPojo.pages}')" >
				</div>
			</div>
			<div id="hotwords"></div>
		</div>
